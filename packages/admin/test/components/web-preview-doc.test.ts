...
describe("buildWebPreviewDoc (F-012 preview fidelity)", () => {
  const base = { variables: ":root { --accent: #c2410c; }", fontImport: "https://fonts.example/x.css" }
  ...
  test("shows the page title unless the body leads with a hero", () => {
    ...
    const heroLed = buildWebPreviewDoc({ ...base, body: '<section class="nac-band nac-hero">...</section>', title: "Pricing", leadsWithHero: true })
